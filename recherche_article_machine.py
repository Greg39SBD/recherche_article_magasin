...
file_path = "Extraction Mainta pieces_equipement.xlsx"  # À adapter selon l'emplacement local
sheet_name = "Feuil2"  # À remplacer par le nom de la feuille pertinente
